              ...
              <div className="flex items-center gap-4 min-w-0">
                <div className="w-10 h-10 bg-white/5 border border-white/5 rounded-lg shrink-0 overflow-hidden relative group-hover:border-white/10 transition-colors">
                  {song.coverUrl ? (
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-[#e8351e]/10 to-transparent" />
                  )}
                </div>
                <div className={cn("truncate font-bold text-sm tracking-tight", currentTrack?.id === song.id ? "text-[#e8351e]" : "text-white/90")}>
                  {song.name}
                </div>
              </div>
